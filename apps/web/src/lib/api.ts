...
/**
 * Core fetch wrapper. Attaches auth header, handles 401 with one silent retry,
 * and maps API error envelopes to ApiError instances.
 */
...
/** Typed HTTP helpers covering the four verbs used by LibraMS routes. */
export const api = {
  /** GET /api/v1/{path} */
